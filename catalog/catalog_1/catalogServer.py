...
def decrease_book_quantity(book_id):
    ...
    if book:
        ...
        if book.quantity - amount < 0:
            ...
            r=requests.put("http://192.168.1.202:4000/bazar/decrease_quantity_con/"+str(book_id),data={'amount':amount})
...
def increase_book_quantity(book_id):
    ...
    if book:
        ...
        r=requests.put("http://192.168.1.202:4000/bazar/increase_quantity_con/"+str(book_id),data={'amount':amount})
        r=requests.delete("http://192.168.1.121:5000/bazar/delete/"+str(book_id))
...
def update_book_price(book_id):
    ...
    if book:
        ...
        r=requests.put("http://192.168.1.202:4000/bazar/update_price_con/"+str(book_id),data={'price':price})
        r=requests.delete("http://192.168.1.121:5000/bazar/delete/"+str(book_id))
        return book_schema.jsonify(book)
    else:  return jsonify({book_id : "this id does not exist"})
